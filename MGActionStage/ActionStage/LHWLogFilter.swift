...
public class LHWFilter {
    ...
    public init(_ target: LHWFilter.TargetType, required: Bool, minLevel: Level) {
...
public class CompareFilter: LHWFilter, LHWFilterType {
    ...
    override public init(_ target: LHWFilter.TargetType, required: Bool, minLevel: Level) {
...
public class FunctionFilterFactory {
    public static func startsWith(_ prefixes: String..., caseSensitive: Bool = false,
                                  required: Bool = false, minLevel: Level = .verbose) -> LHWFilterType {
